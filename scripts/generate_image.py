    ...
    'lancashire-council-tax-breakdown': {
        ...
        'viz_cards': [
            ...
            },
            {
                ...
                'type': 'table',
                'title': 'A Decade of Council Tax Rises',
                'source': 'LCC council tax breakdown PDFs, lancashire.gov.uk. Caps: GOV.UK referendum principles.',
                'data': {
                    'headers': ['Year', 'Control', 'Core', 'Cap', 'ASC', 'Cap', 'Total'],
                    'rows': [
                        ['2016/17', 'Con (NOC)', '1.99%', '2%', '2.00%', '2%', '3.99%'],
                        ['2017/18', 'Con (NOC)', '1.99%', '2%', '2.00%', '3%', '3.99%'],
                        ...
                        ['2025/26', 'Con*', '2.99%', '3%', '2.00%', '2%', '4.99%'],
                        ['2026/27', 'Reform UK', '1.80%', '3%', '2.00%', '2%', '3.80%'],
                    ],
                    'highlight_rows': [10],
                    'col_weights': [0.13, 0.20, 0.12, 0.10, 0.12, 0.10, 0.12],
                },
            },
            {
                'slug': 'reform-choice',
                ...
                'data': {
                    'before': {'value': '2.99%', 'label': 'Conservative Core', 'sublabel': 'Hit the cap in 2024/25 and 2025/26.'},
