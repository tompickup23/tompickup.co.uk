...
category: "DOGE"
subcategory: "Burnley"
tags: ["doge", "burnley", "homelessness", "asylum", "spending", "data"]
featured: false
draft: false
---
...
<strong>A note on the figures.</strong> Spending is reproduced from Burnley Borough Council's own published data for transparency. It is not the official record and may contain errors, so verify against the source before relying on a figure. No liability is accepted. Naming a hotel, charity or company is not an allegation of any wrongdoing; it simply reflects a payment recorded in the council's published data, or a provider named in the council's own homelessness reports.
</div>
...
- **The spending** is from Burnley Borough Council's [published "payments over £500" data](https://burnley.gov.uk/council-democracy/council-spending/), 2021/22 to 2025/26, in the "Housing Advice" cost centre. The £2.47m total, the provider amounts, and the hotel-vs-supported split are all sums of that data. The same payments are searchable in my [DOGE spending explorer](/doge/burnley-council/spending/2025-26/). This is over-£500 payments only, so it excludes sub-£500 placements and is **gross** of the Housing Benefit subsidy the council reclaims, meaning the net cost to the council is lower than the headline.
