...
<div>
<div style="display:flex; justify-content:space-between; margin-bottom:5px;"><span class="text-white text-bold">Trinity</span><span class="text-teal text-bold">248 &nbsp;(8.9% of homes)</span></div>
<div class="viz-reform-bar"><div class="fill teal" style="width:100%;"></div></div>
</div>
<div>
<div style="display:flex; justify-content:space-between; margin-bottom:5px;"><span class="text-muted">Bank Hall</span><span class="text-muted">142 &nbsp;(5.1%)</span></div>
<div class="viz-reform-bar"><div class="fill" style="width:57%; background:rgba(255,255,255,0.18);"></div></div>
</div>
<div>
<div style="display:flex; justify-content:space-between; margin-bottom:5px;"><span class="text-muted">Daneshouse with Stoneyholme</span><span class="text-muted">128 &nbsp;(4.8%)</span></div>
<div class="viz-reform-bar"><div class="fill" style="width:52%; background:rgba(255,255,255,0.18);"></div></div>
</div>
<div>
<div style="display:flex; justify-content:space-between; margin-bottom:5px;"><span class="text-muted">Queensgate</span><span class="text-muted">115 &nbsp;(4.2%)</span></div>
<div class="viz-reform-bar"><div class="fill" style="width:46%; background:rgba(255,255,255,0.18);"></div></div>
</div>
<div>
<div style="display:flex; justify-content:space-between; margin-bottom:5px;"><span class="text-muted">Gawthorpe</span><span class="text-muted">72 &nbsp;(2.6%)</span></div>
<div class="viz-reform-bar"><div class="fill" style="width:29%; background:rgba(255,255,255,0.18);"></div></div>
</div>
<div>
<div style="display:flex; justify-content:space-between; margin-bottom:5px;"><span class="text-muted">Rosehill with Burnley Wood</span><span class="text-muted">63 &nbsp;(2.3%)</span></div>
<div class="viz-reform-bar"><div class="fill" style="width:25%; background:rgba(255,255,255,0.18);"></div></div>
</div>
</div>
</div>
