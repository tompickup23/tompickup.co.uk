...
Announcements tell you the map. They don't tell you what the new councils actually inherit. So I built a model that does — every figure traceable to a published source, and the whole dataset downloadable.

[**Explore the interactive model →**](/lgr/)
