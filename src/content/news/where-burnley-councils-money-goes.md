...
For scale, the borough's own share of your council tax is **£344.58** a year on a band D home, and council tax covers roughly **44%** of the council's net running costs. The £38 million below is far larger than council tax alone, because it is paid for from many sources at once: government grants, fees and charges, reserves, and capital funding for building work. This page does not tell you the council is overspending or underspending. It tells you, line by line, where the money it did spend actually went.
